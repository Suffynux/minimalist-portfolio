      ...
      >
        <div className="grid min-h-[400px] grid-cols-1 lg:grid-cols-[1.05fr_1fr]">
          <div className="flex flex-col justify-between gap-[30px] p-8 sm:p-11">
            <div className="flex items-center justify-between gap-4 font-mono text-xs text-meta">
            ...
            <div>
              ...
              <p className="mb-[22px] font-mono text-[12.5px] text-meta">{project.meta}</p>
              <p className="max-w-[440px] text-base leading-[1.62] text-shade-deep">{project.desc}</p>
            </div>
            <TagList tags={project.stack} dark />
          </div>
          <div className="relative min-h-[300px] overflow-hidden bg-ink">
...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Reveal>
      ...
      >
        <div className="relative h-[170px] overflow-hidden bg-shade">
        ...
        <div className="flex flex-1 flex-col gap-[13px] px-[26px] pb-[30px] pt-[26px]">
          ...
          <p className="-mt-1 font-mono text-[11.5px] text-meta">{project.meta}</p>
          <p className="flex-1 text-sm leading-[1.6] text-body">{project.desc}</p>
